namespace EFCourse.Vidzy.Migrations
{
    ...
    public partial class AddedConstraintsToVideoAndGenreTables : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Videos", "Clasification", c => c.Byte(nullable: false));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.Videos", "Clasification", c => c.Int(nullable: false));
